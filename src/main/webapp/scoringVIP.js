    ...
    reader.readAsArrayBuffer(e.target.files[0]);
  	reader.onload = function(e) {
		...
		*/
		...
		var top24 = lst_scores[24];
		var nombre_top24 = top24['jugador'];
		document.getElementById('nombre_top24').innerHTML = top24['jugador'];
		var equipo_top24 = top24['equipo'];
		document.getElementById('equipo_top24').innerHTML = top24['equipo'];
		var score_top24 = top24['score'];
		document.getElementById('score_top24').innerHTML = top24['score'];
		
		var top25 = lst_scores[25];
		var nombre_top25 = top25['jugador'];
		document.getElementById('nombre_top25').innerHTML = top25['jugador'];
		var equipo_top25 = top25['equipo'];
		document.getElementById('equipo_top25').innerHTML = top25['equipo'];
		var score_top25 = top25['score'];
		document.getElementById('score_top25').innerHTML = top25['score'];
		
		var top26 = lst_scores[26];
		var nombre_top26 = top26['jugador'];
		document.getElementById('nombre_top26').innerHTML = top26['jugador'];
		var equipo_top26 = top26['equipo'];
		document.getElementById('equipo_top26').innerHTML = top26['equipo'];
		var score_top26 = top26['score'];
		document.getElementById('score_top26').innerHTML = top26['score'];
		
		var top27 = lst_scores[27];
		var nombre_top27 = top27['jugador'];
		document.getElementById('nombre_top27').innerHTML = top27['jugador'];
		var equipo_top27 = top27['equipo'];
		document.getElementById('equipo_top27').innerHTML = top27['equipo'];
		var score_top27 = top27['score'];
		document.getElementById('score_top27').innerHTML = top27['score'];
